$(document).ready(function() {
  $('#countdown').countdown(new Date(2015, 2, 2, 20, 30)).on('update.countdown', function(event) {
    ...
    return $("#seconds").val(event.offset.seconds).trigger('change');
  });
  $("#days").knob({
    min: 0,
    max: 7,
  ...
  return $("#seconds").after("<span class='label'>seconds</span>");
});
